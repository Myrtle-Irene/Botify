...
def fetch(query, working_database):
...
def print_help_message():
    ...
    print '\t-s <path>\t\tpath to working database file'
    print '\n'

def main(argv):
    try:
        opts, args = getopt.getopt(argv,"d:l:i:t:j:s:")
        database_path = None
        input_sentence = None
        language_path = None
        thesaurus_path = None
        ...
        ln2sql(str(database_path), str(input_sentence), str(language_path), thesaurus_path, json_output_path, working_database)
